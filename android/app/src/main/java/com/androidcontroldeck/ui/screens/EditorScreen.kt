...
fun EditorScreen(
    ...
    val validationResult = remember { mutableStateOf<com.androidcontroldeck.data.storage.ProfileValidationResult?>(null) }
                ...
                context.contentResolver.openInputStream(it)?.use { inputStream ->
                    ...
                    if (result.first) {
                        try {
                            ...
                            validationResult.value = com.androidcontroldeck.data.storage.ProfileValidationResult(
                                isValid = false,
                                errors = listOf(
                        ...
                        validationResult.value = com.androidcontroldeck.data.storage.ProfileValidationResult(
                            ...
                            errors = listOf(
                                com.androidcontroldeck.data.storage.ValidationError(
                                    field = "json",
                                    message = result.second ?: "JSON invalide"
                                )
                            )
                        )
                    }
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ...
                    }) { Icon(Icons.Default.ContentCopy, contentDescription = stringResource(R.string.editor_duplicate)) }
                            ...
                            .pointerInput(control.id) {
                                detectDragGestures { change, dragAmount ->
                                    ...
                                    if (deltaRows != 0 || deltaCols != 0) {
                                        ...
                                        updateControl(updated, editableProfile.value!!, onProfileChanged, undoRedoManager)
...
private fun updateControl(control: Control, profile: Profile, onProfileChanged: (Profile) -> Unit, undoRedoManager: UndoRedoManager<Profile>) {
...
@Composable
fun rememberCachedIcon(name: String?, assetCache: AssetCache): androidx.compose.runtime.State<ImageBitmap?> {
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Slider(
                ...
                onValueChange = { onChange(control.copy(colSpan = it.roundToInt().coerceIn(1, 4))) },
                steps = 3,
                valueRange = 1f..4f,
            ...
            Slider(
                ...
                onValueChange = { onChange(control.copy(rowSpan = it.roundToInt().coerceIn(1, 4))) },
                steps = 3,
                valueRange = 1f..4f,
