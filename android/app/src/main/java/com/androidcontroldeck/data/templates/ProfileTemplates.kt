...
/**
 * Templates de profils prédéfinis pour différents cas d'usage Icônes disponibles: Play, Pause,
 * SkipBack, SkipForward, Volume2, VolumeX, Mic, MicOff, Monitor, Camera, Radio, Save, FolderOpen,
 * Printer, Copy, Clipboard, Undo2, Redo2, Lock, Sun, AppWindow, Gamepad2, Headphones, Music, Film,
 * Settings, Power, RefreshCw
 */
object ProfileTemplates {

    /**
     * Template Mixage Audio Windows - Contrôle du volume par application Premier template car le
     * plus utile pour un usage quotidien
     */
                                ...
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        ...
                                                        payload =
                                                                """{"action": "SET_DEVICE_VOLUME", "device": "default"}"""
                                                )
                                ),
                                Control(
                                        id = "fader_app1",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "chrome"}"""
                                                )
                                ),
                                Control(
                                        id = "fader_app2",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "spotify"}"""
                                                )
                                ),
                                Control(
                                        id = "fader_app3",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "discord"}"""
                                                )
                                ),
                                Control(
                                        id = "fader_app4",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "firefox"}"""
                                                )
                                ),
                                Control(
                                        id = "btn_mute_master",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload = """{"action": "SET_DEVICE_MUTE", "device": "default", "mute": true}"""
                                                )
                                ),
                                Control(
                                        id = "btn_unmute",
                                        ...
                                        row = 1,
                                        col = 5,
                                        label = nameProvider("template_unmute"),
                                        icon = "Volume2",
                                        colorHex = "#22C55E",
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload = """{"action": "SET_DEVICE_MUTE", "device": "default", "mute": false}"""
                                                )
                                )
                        )
        )
    ...
    /** Template pour utilisateur lambda - Usage quotidien simplifié */
                                ...
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        ...
                                                        payload =
                                                                """{"action": "media", "payload": {"action": "previous"}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_play_pause",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"action": "media", "payload": {"action": "play_pause"}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_next",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"action": "media", "payload": {"action": "next"}}"""
                                                )
                                ),
                                Control(
                                        id = "toggle_mute",
                                ...
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"action": "screenshot", "payload": {"type": "full"}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_lock",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"action": "system", "payload": {"action": "lock"}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_brightness",
                                        ...
                                        row = 2,
                                        col = 2,
                                        label = nameProvider("template_bright"),
                                        icon = "Sun",
                                        colorHex = "#FBBF24",
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"action": "system", "payload": {"action": "brightness", "value": 100}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_apps",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"action": "system", "payload": {"action": "open_apps"}}"""
                                                )
                                )
                        )
        )
                                ...
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "Game", "volume": 50}"""
                                                )
                                ),
                                Control(
                                        id = "btn_discord_mute",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "mute", "payload": {"toggle": true}}"""
                                                )
                                ),
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "deafen", "payload": {"toggle": true}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_media_play",
                                ...
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "MUTE", "params": {"inputName": "Mic/Aux"}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_mute_desktop",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "MUTE", "params": {"inputName": "Desktop Audio"}}"""
                                                )
                                ),
                                Control(
                                        id = "pad_scene1",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "SET_SCENE", "params": {"sceneName": "Camera"}}"""
                                                )
                                ),
                                Control(
                                        id = "pad_scene2",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "SET_SCENE", "params": {"sceneName": "Screen"}}"""
                                                )
                                ),
                                Control(
                                        id = "pad_scene3",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "SET_SCENE", "params": {"sceneName": "Game"}}"""
                                                )
                                ),
                                Control(
                                        id = "pad_scene4",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "SET_SCENE", "params": {"sceneName": "BRB"}}"""
                                                )
                                ),
                                Control(
                                        id = "pad_scene5",
                                        ...
                                        row = 1,
                                        col = 4,
                                        label = nameProvider("template_ending"),
                                        icon = "X",
                                        colorHex = "#6B7280",
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "SET_SCENE", "params": {"sceneName": "Ending"}}"""
                                                )
                                ),
                                Control(
                                        id = "fader_mic",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "SET_VOLUME", "params": {"inputName": "Mic/Aux", "volumeDb": 0}}"""
                                                )
                                ),
                                Control(
                                        id = "fader_music",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "spotify.exe", "volume": 50}"""
                                                )
                                ),
                                Control(
                                        id = "fader_alerts",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.OBS,
                                                        payload =
                                                                """{"action": "SET_VOLUME", "params": {"inputName": "Alerts", "volumeDb": 0}}"""
                                                )
                                )
                        )
        )
    ...
    /** Template pour Discord - Contrôles vocaux et statuts */
                ...
                controls =
                        listOf(
                                ...
                                Control(
                                        ...
                                        row = 0,
                                        col = 2,
                                        label = nameProvider("template_leave"),
                                        icon = "PhoneOff",
                                        colorHex = "#EF4444",
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "leave_voice", "payload": {}}"""
                                                )
                                ),
                                Control(
                                        id = "btn_discord_join",
                                        ...
                                        row = 0,
                                        col = 3,
                                        label = nameProvider("template_join"),
                                        icon = "Phone",
                                        colorHex = "#22C55E",
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "join_voice", "payload": {"channelId": "default"}}"""
                                                )
                                ),
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "set_volume", "payload": {"volume": 100}}"""
                                                )
                                ),
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "set_mic_volume", "payload": {"volume": 100}}"""
                                                )
                                ),
                                Control(
                                        ...
                                        row = 2,
                                        col = 0,
                                        label = nameProvider("template_live"),
                                        icon = "Radio",
                                        colorHex = "#9146FF",
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "set_presence", "payload": {"preset": "streaming"}}"""
                                                )
                                ),
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "set_presence", "payload": {"preset": "gaming"}}"""
                                                )
                                ),
                                Control(
                                        ...
                                        row = 2,
                                        col = 2,
                                        label = nameProvider("template_work"),
                                        icon = "Briefcase",
                                        colorHex = "#F97316",
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "set_presence", "payload": {"preset": "working"}}"""
                                                )
                                ),
                                Control(
                                        ...
                                        row = 2,
                                        col = 3,
                                        label = nameProvider("template_afk"),
                                        icon = "Moon",
                                        colorHex = "#6B7280",
                                        action =
                                                Action(
                                                        type = ActionType.CUSTOM,
                                                        payload =
                                                                """{"plugin": "discord", "action": "set_presence", "payload": {"preset": "idle"}}"""
                                                )
                                )
                        )
        )
                                ...
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "DAW", "volume": 50}"""
                                                )
                                ),
                                Control(
                                        id = "fader_track2",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_APPLICATION_VOLUME", "application": "Browser", "volume": 50}"""
                                                )
                                ),
                                Control(
                                        id = "fader_mic1",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_DEVICE_VOLUME", "device": "default", "volume": 50}"""
                                                )
                                ),
                                Control(
                                        id = "knob_balance",
                                ...
                                Control(
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_DEFAULT_DEVICE", "deviceId": "default", "deviceType": "output"}"""
                                                )
                                ),
                                Control(
                                        id = "btn_input_switch",
                                        ...
                                        action =
                                                Action(
                                                        type = ActionType.AUDIO,
                                                        payload =
                                                                """{"action": "SET_DEFAULT_DEVICE", "deviceId": "default", "deviceType": "input"}"""
                                                )
                                ),
                                Control(
                                        id = "btn_reset",
    ...
    /** Template pour la productivité - Raccourcis bureautique */
                ...
                controls =
                        listOf(
                                ...
                                Control(
                                        ...
                                        row = 2,
                                        col = 3,
                                        label = nameProvider("template_vol"),
                                        icon = "Volume2",
                                        colorHex = "#22C55E",
                                        minValue = 0f,
                                        maxValue = 100f,
    ...
    fun getTemplateById(templateId: String, nameProvider: (String) -> String): Profile? {
        return when (templateId) {
            "template_mixer" -> mixerTemplate(nameProvider)
